...
#define SI446X_TX_PWR_PIN   0
#define SI446X_TX_PWR_BIT   (1 << SI446X_TX_PWR_PIN)
#define SI446X_TX_PWR_3V3   BITBAND_PERI(SI446X_TX_PWR_PORT->OUT, SI446X_TX_PWR_PIN) = 1
#define SI446X_TX_PWR_1V8   BITBAND_PERI(SI446X_TX_PWR_PORT->OUT, SI446X_TX_PWR_PIN) = 0
#define SI446X_TX_PWR_HI_P  (SI446X_TX_PWR_PORT->OUT & SI446X_TX_PWR_BIT)
