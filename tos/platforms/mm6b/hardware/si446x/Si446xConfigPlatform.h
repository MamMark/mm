 ...
 * gp2: gp3: tx_state (32), rx_state (33) NOTE: OPPOSITE OF DEV BOARD
 *      Transmit: gp2=1, gp3=0
 *      Receive:  gp2=0, gp3=1
 *      NIRQ, SDO, GEN_CONFIG =0
 */
#define SI446X_GPIO_PIN_CFG_LEN    8
#define SI446X_RF_GPIO_PIN_CFG     SI446X_CMD_GPIO_PIN_CFG, SI446X_GPIO_IN_SLEEP, SI446X_GPIO_CTS, SI446X_GPIO_TX_STATE, SI446X_GPIO_RX_STATE, 0x00, 0x00, 0x00
