...
void __map_ports() {
  ...
  P7MAP->PMAP_REG[0] = PMAP_UCA0CLK;
  P7MAP->PMAP_REG[1] = PMAP_TA1CCR1A;
  P7MAP->PMAP_REG[2] = PMAP_UCA0SOMI;
  P7MAP->PMAP_REG[3] = PMAP_UCA0SIMO;
...
void __Reset() {
  ...
  P5->OUT = 0xA1;                       /* gps_mems_1V8_en, gyro_csn    */
  P5->DIR = 0xA7;                       /* power gps/mems first */
  P1->DIR = 0x64;                       /* switch the csn's to outputs */
