 ...
 * Hardware Notes:
 *
 * MamMark mm6b is the production animal tag based on the TI msp432p402r
 ...
 *
 * A0: gps       spi/uart ublox-zoe  (dma overlap/AES, DMA ch 0, 1)
 ...
 * through the I/O pin).  We do this by changing these pins to Port/Input.
 *
 * dc - dock_comm
 *
 * Port: (0x4000_4C00)
 ...
 *        .5    1pO   C8 gps_csn                 61 I .1        0pO   G4 dock_sd0_override  TP12
 ...
 *  43 O  .2    0pI   A9 gps_tx_rdy             122 O  .2       1pO   A6 gps_resetn
 ...
 * (dep) deprecated
 *
 * dock-01 - TP28 - jtag RSTn                   dock-02 - TP11 - dock_comm_sclk     P2.0
 * dock-03 - TP23 - jtag swdio                  dock-04 - TP27 - dock_comm_attn_m   P1.3
 * dock-05 - TP32 - jtag swo                    dock-06 - TP31 - dock_comm_attn_s   P1.2
 * dock-07 - TP18 - jtag swclk                  dock-08 - TP03 - dock_comm_simo     P2.3
 * dock-09 - TP13 - dock_comm_somi   P3.2       dock-10 - TP12 - dock_sd0_override
