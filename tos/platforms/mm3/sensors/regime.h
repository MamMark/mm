...
const uint32_t sns_period_table[MM_NUM_REGIMES][MM_NUM_SENSORS] = {
  ...
  {  0UL,    0UL,      1024UL,    0UL,       0UL,       0UL,       0UL,       0UL,       0UL,       0UL     }, /* 4 */
  ...
  {  0UL,    0UL,      1024UL,    1024UL,    1024UL,    0UL,       0UL,       0UL,       0UL,       0UL     }, /* 14 - testing */
  {  0UL,    0UL,      0UL,       0UL,       0UL,       51UL,      0UL,       0UL,       0UL,       51UL    }, /* 15 - accel, mag, 20 Hz */
};
