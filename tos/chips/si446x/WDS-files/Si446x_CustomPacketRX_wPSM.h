...
// MOD_type: 3    Rsymb(sps): 1000    Fdev(Hz): 20000    RXBW(Hz): 10000    Manchester: 0    AFC_en: 2    Rsymb_error: 0.0    Chip-Version: 2
// RF Freq.(MHz): 433    API_TC: 29    fhst: 200000    inputBW: 1    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1
// API_ARR_Det_en: 2    Fdev_error: 0    API_ETSI: 0
//
// # RX IF frequency is  -468750 Hz
// # WB filter 4 (BW =  10.33 kHz);  NB-filter 4 (BW = 10.33 kHz)
//
// Modulation index: 40
*/
...
*/
#define RF_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x03, 0x00, 0x07, 0x00, 0x9C, 0x40, 0x05, 0xC9, 0xC3, 0x80, 0x00, 0x05
...
*/
#define RF_MODEM_TX_RAMP_DELAY_12 0x11, 0x20, 0x0C, 0x18, 0x01, 0x80, 0x08, 0x03, 0x80, 0x00, 0xB0, 0x20, 0x14, 0xE8, 0x01, 0xD5
...
*/
#define RF_MODEM_BCR_NCO_OFFSET_2_12 0x11, 0x20, 0x0C, 0x24, 0x01, 0x17, 0x9F, 0x00, 0x8C, 0x12, 0xC2, 0x00, 0x04, 0x23, 0x80, 0x01
...
*/
#define RF_MODEM_AFC_LIMITER_1_3 0x11, 0x20, 0x03, 0x30, 0x4E, 0xAC, 0xC0
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_12 0x11, 0x20, 0x0C, 0x38, 0x11, 0x67, 0x67, 0x80, 0x1A, 0xFF, 0xFF, 0x00, 0x2A, 0x0C, 0xA4, 0x22
...
*/
#define RF_MODEM_RAW_CONTROL_10 0x11, 0x20, 0x0A, 0x45, 0x83, 0x06, 0xEC, 0x01, 0x00, 0xFF, 0x06, 0x0A, 0x1A, 0x40
...
*/
#define RF_MODEM_SPIKE_DET_2 0x11, 0x20, 0x02, 0x54, 0x97, 0xC6
...
*/
#define RF_MODEM_PSM_1_7 0x11, 0x20, 0x07, 0x59, 0x0F, 0xFF, 0x66, 0x24, 0x34, 0x78, 0x22
...
#define SI446X_CUSTOMPACKETRX_WPSM_NAME "Si446x_CustomPacketRX_wPSM"
#define SI446X_CUSTOMPACKETRX_WPSM_DATA_ARRAY { \
SI446X_PATCH_CMDS, \
0x07, RF_POWER_UP, \
...
#else
#define SI446X_CUSTOMPACKETRX_WPSM_NAME "Si446x_CustomPacketRX_wPSM"
#define SI446X_CUSTOMPACKETRX_WPSM_DATA_ARRAY { 0 }
#endif
...
#define SI446X_CUSTOMPACKETRX_WPSM_NAME "Si446x_CustomPacketRX_wPSM"
#ifndef SI446X_CUSTOMPACKETRX_WPSM_DATA_ARRAY
