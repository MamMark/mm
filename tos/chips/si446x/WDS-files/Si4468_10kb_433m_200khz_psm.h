...
// MOD_type: 3    Rsymb(sps): 10000    Fdev(Hz): 20000    RXBW(Hz): 150000    Manchester: 0    AFC_en: 3    Rsymb_error: 0.0    Chip-Version: 2
// RF Freq.(MHz): 433    API_TC: 29    fhst: 200    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1
...
#define RADIO_CONFIGURATION_DATA_CUSTOM_PAYLOAD                                    {0x3F, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, \
...
*/
#define RF_GPIO_PIN_CFG 0x13, 0x48, 0x26, 0x20, 0x21, 0x00, 0x00, 0x00
...
*/
#define RF_PKT_CRC_CONFIG_12 0x11, 0x12, 0x0C, 0x00, 0x04, 0x01, 0x08, 0xFF, 0xFF, 0x20, 0x02, 0x00, 0x2A, 0x01, 0x00, 0x30
...
*/
#define RF_PKT_RX_THRESHOLD_12 0x11, 0x12, 0x0C, 0x0C, 0x28, 0x00, 0x01, 0x04, 0x82, 0x00, 0x3F, 0x00, 0x0A, 0x00, 0x00, 0x00
...
*/
#define RF_MODEM_BCR_NCO_OFFSET_2_12 0x11, 0x20, 0x0C, 0x24, 0x01, 0x5D, 0x86, 0x00, 0xAF, 0x02, 0xC0, 0x00, 0x94, 0x23, 0x81, 0x55
...
*/
#define RF_MODEM_AFC_LIMITER_1_3 0x11, 0x20, 0x03, 0x30, 0x01, 0x5D, 0x80
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_12 0x11, 0x20, 0x0C, 0x38, 0x11, 0x52, 0x52, 0x80, 0x1A, 0xFF, 0xFF, 0x00, 0x2A, 0x0C, 0x84, 0x23
...
*/
#define RF_MODEM_RAW_CONTROL_10 0x11, 0x20, 0x0A, 0x45, 0x8F, 0x00, 0xDE, 0x01, 0x00, 0x50, 0x06, 0x0A, 0x1A, 0x40
...
*/
#define RF_MODEM_SPIKE_DET_2 0x11, 0x20, 0x02, 0x54, 0x83, 0x41
...
*/
#define RF_MODEM_PSM_1_7 0x11, 0x20, 0x07, 0x59, 0x02, 0x35, 0x66, 0x64, 0x07, 0x78, 0x22
...
*/
#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x38, 0x0D, 0xDD, 0xDD, 0x00, 0x0E, 0x20, 0xFE
...
#define SI4468_10KB_433M_200KHZ_PSM_IDS {5883792, 30000000, 10000, 20000, 200, 150000}
#define SI4468_10KB_433M_200KHZ_PSM_NAME "Si4468_10kb_433m_200khz_psm"
#define SI4468_10KB_433M_200KHZ_PSM_DATA_ARRAY { \
SI446X_PATCH_CMDS, \
0x07, RF_POWER_UP, \
...
#define SI4468_10KB_433M_200KHZ_PSM_IDS {5883792, 30000000, 10000, 20000, 200, 150000}
#define SI4468_10KB_433M_200KHZ_PSM_NAME "Si4468_10kb_433m_200khz_psm"
#define SI4468_10KB_433M_200KHZ_PSM_DATA_ARRAY { 0 }
#endif
...
#define SI4468_10KB_433M_200KHZ_PSM_IDS {5883792, 30000000, 10000, 20000, 200, 150000}
#define SI4468_10KB_433M_200KHZ_PSM_NAME "Si4468_10kb_433m_200khz_psm"
#ifndef SI4468_10KB_433M_200KHZ_PSM_DATA_ARRAY
