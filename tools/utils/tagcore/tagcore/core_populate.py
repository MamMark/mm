...
dtd.dt_records[DT_SENSOR_DATA]      = (  0, decode_sensor,  [ emit_sensor_data, emit_influx ],      obj_dt_sen_data(),        'SENSOR',       'obj_dt_sen_data' )
dtd.dt_records[DT_SENSOR_SET]       = (  0, decode_default, [ emit_sensor_set, emit_influx ],       obj_dt_sen_set(),         'SENSOR_SET',   'obj_dt_sen_set'  )
...
dtd.dt_records[DT_GPS_TRACKING]     = (  0, decode_gps_trk, [ emit_gps_tracking, emit_influx ],     obj_dt_gps_tracking(),    'GPS_TRK',      'obj_dt_tracking' )
