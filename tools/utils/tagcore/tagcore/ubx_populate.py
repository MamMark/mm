...
ubx.cid_table[0x0500]   = (decode_ubx_ack,     [ emit_ubx_ack ],           obj_ubx_ack(),             'ack/nack',     'obj_ubx_ack')
ubx.cid_table[0x0501]   = (decode_ubx_ack,     [ emit_ubx_ack ],           obj_ubx_ack(),             'ack/ack',      'obj_ubx_ack')
