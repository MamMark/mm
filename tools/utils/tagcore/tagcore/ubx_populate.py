...
ubx.cid_table[0x063e]   = (decode_ubx_cfg_gnss,[ emit_ubx_cfg_gnss ],      obj_ubx_cfg_gnss(),        'cfg/gnss',     'obj_ubx_cfg_gnss')
...
ubx.cid_table[0x060e]   = (decode_null, None, None, 'cfg/fxn',          'none')
ubx.cid_table[0x0611]   = (decode_null, None, None, 'cfg/rxm',          'none')
ubx.cid_table[0x0612]   = (decode_null, None, None, 'cfg/ekf',          'none')
...
ubx.cid_table[0x061D]   = (decode_null, None, None, 'cfg/tmode',        'none')
ubx.cid_table[0x061E]   = (decode_null, None, None, 'cfg/odo',          'none')
ubx.cid_table[0x0629]   = (decode_null, None, None, 'cfg/esfgwt',       'none')
ubx.cid_table[0x0631]   = (decode_null, None, None, 'cfg/tp5',          'none')
ubx.cid_table[0x0632]   = (decode_null, None, None, 'cfg/pm',           'none')
...
ubx.cid_table[0x0a0d]   = (decode_null, None, None, 'mon/llc',          'none')
